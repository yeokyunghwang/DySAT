...
class TemporalAttentionLayer(Layer):
    ...
    def __call__(self, inputs):
        ...
        # tf.contrib.linalg was folded into tf.linalg; band_part(-1, 0) keeps
        # the lower triangle including the diagonal, which is the same mask.
        tril = tf.linalg.band_part(diag_val, -1, 0)  # [T, T]
